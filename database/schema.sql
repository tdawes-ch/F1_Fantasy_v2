...
CREATE TABLE IF NOT EXISTS fantasy_raw_driver_data ( -- data from the fantasy json
    ...
    oldplayervalue REAL,
    bestracefinished INTEGER,
    highestgridstart INTEGER,
    highestchampfinish TEXT,
    fastestpitstopaward TEXT,
    bestracefinishcount INTEGER,
    highestgridstartcount INTEGER,
    highestchampfinishcount INTEGER,
    fastestpitstopawardcount INTEGER,
    qualifyingpoints INTEGER,
    racepoints TEXT,
    sprintpoints INTEGER,
    nonegativepoints REAL,
    f1playerid INTEGER,
    firstname TEXT,
    lastname TEXT,
    sessionwisepoints TEXT, -- just store all of this as a text
    additionalstats TEXT, -- same with this, all just text
    old_Value REAL,
    new_value REAL,
